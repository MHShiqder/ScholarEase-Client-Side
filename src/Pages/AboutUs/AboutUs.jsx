...
const AboutUs = () => {
    return (
        <div className="bg-background text-primary min-h-screen py-12 px-4 sm:px-6 md:px-12 lg:px-24">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center max-w-6xl mx-auto">
                <motion.div 
                    className="p-6 bg-primary rounded-xl shadow-lg"
                    initial={{ opacity: 0, x: -50 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.6 }}
                >
                    <h2 className="text-xl sm:text-2xl font-semibold text-secondary">Our Mission</h2>
                    <p className="mt-3 text-accent text-sm sm:text-base">
                ...
                <motion.div 
                    ...
                    transition={{ duration: 0.6 }}
                >
                    <h2 className="text-xl sm:text-2xl font-semibold text-secondary">Why Choose Us?</h2>
                    <p className="mt-3 text-accent text-sm sm:text-base">
