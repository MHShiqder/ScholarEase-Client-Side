...
const Success = () => {
    ...
    return (
        <div id="animateMe2" className={`bg-primary/10 w-11/12 mx-auto pb-10 bg-cover bg-right text-white px-5 my-20 animate__animated ${isVisible ? 'animate__fadeInRight' : ''}`}>
            <h1 className="text-2xl md:text-5xl font-bold py-10 text-center text-[#320a4e]">ScholarEase Statistics</h1>
            <div className="grid grid-cols-2 md:grid-cols-4 text-[#320a4e] gap-5 ">
                <div className="flex flex-col items-center  bg-[#ffffff3b]  py-10 space-y-3 border-2 border-secondary ">
                ...
                <div className="flex flex-col items-center bg-[#ffffff3b] border-2 border-secondary py-10 space-y-3 ">
