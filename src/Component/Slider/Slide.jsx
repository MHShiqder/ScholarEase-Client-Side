...
const Slide = ({ Heading, image, Bold, subHeading, index }) => {
    return (
            ...
            <div className='bg-gradient-to-r from-black  to-transparent h-full '>
                <div className='w-11/12 mx-auto flex flex-col  justify-center  h-full'>
                    ...
                    <motion.button
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <Link className=' bg-primary/90 px-1 py-1 md:py-2 rounded-md w-32 md:w-36 lg:text-base text-sm text-white  mt-2 md:mt-3 lg:mt-5  flex justify-around items-center hover:scale-105' to="all-scholarship">Explore Now <span><FaArrowRight></FaArrowRight></span> </Link>
                    </motion.button>
                </div>
            </div>
        </div>
