    ...
    <section className="pb-20 w-11/12 mx-auto text-center">
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 gap-12  mx-auto justify-items-center">
        {teamMembers.map((member, index) => (
          <div key={index} className="relative bg-white shadow-xl rounded-lg  p-8 overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-2xl w-72 md:w-full">
            ...
            <div>
              <h3 className="text-lg lg:text-2xl font-semibold text-gray-800">{member.name}</h3>
              <p className="text-indigo-500 text-sm lg:text-lg font-medium mb-4">{member.role}</p>
